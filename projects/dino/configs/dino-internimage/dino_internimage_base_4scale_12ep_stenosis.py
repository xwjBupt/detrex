...
train.init_checkpoint = "/ai/mnt/code/detrex/projects/dino/configs/dino-internimage/dino_internimage_base_4scale_12ep.pth"
train.output_dir = (
    "/ai/mnt/code/detrex/ouput_dirs/dino_internimage_base_4scale_12ep_stenosis_binary"
)
